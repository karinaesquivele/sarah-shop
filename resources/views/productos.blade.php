		...
		@foreach ($productos as $producto)
			<div class='col-lg-4 col-md-4 col-sm-12 col-xs-12'>
				...
				<div class="contenedor1 text-right">
					<div class="boton">
						<a class="btn btn-white" href="{{route('agregar',$producto->_id)}}" id="{{$producto->_id}}">
							<i class="fa fa-cart-plus" style="font-size:24px"></i>
						</a>
					</div>
				</div>
				<div class="card-body">
					<a class="card-title" type="button" href="{{route('producto_individual',$producto->_id)}}">{{$producto->modelo}}</a>
